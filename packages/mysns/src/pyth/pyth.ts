...
export class MysPriceServiceConnection extends PriceServiceConnection {
	/**
...
export class MysPythClient {
	...
	constructor(provider: MysClient, pythStateId: ObjectId, wormholeStateId: ObjectId) {
