...
```tsx
import { useSuiClientQueries } from '@mysocial/dapp-kit';
...
```tsx
import { useSuiClientInfiniteQuery } from '@mysocial/dapp-kit';
...
```tsx
import { useSuiClientMutation } from '@mysocial/dapp-kit';
...
```tsx
import { useResolveSuiNSName } from '@mysocial/dapp-kit';
