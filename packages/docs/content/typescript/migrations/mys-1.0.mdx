...
```diff
- import { SuiClient } from '@mysocial/sui.js'
+ import { SuiClient } from '@mysocial/sui'
```
...
```diff
- import { Transactions } from '@mysocial/sui/transactions'
+ import { Commands } from '@mysocial/sui/transactions'
...
```diff
- import { publicKeyFromSuiBytes } from '@mysocial/sui/multisig'
...
```diff
- import { getSentTransactionBlocksWithLinks, ZkSendLinkBuilder } from '@mysocial/zksend'
+ import { getSentTransactionsWithLinks, ZkSendLinkBuilder } from '@mysocial/zksend'
...
```ts
import { signAndExecuteTransaction, signTransaction } from '@mysocial/wallet-standard';
