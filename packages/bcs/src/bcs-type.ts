...
import { fromBase58, fromBase64, toBase58, toBase64, fromHex, toHex } from '@socialproof/utils';
...
const SERIALIZED_BCS_BRAND = Symbol.for('@socialproof/serialized-bcs') as never;
