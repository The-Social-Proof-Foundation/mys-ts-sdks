...
describe('Keypair', () => {
	...
	it('`toMysAddress()` should return a valid mys address', async () => {
		expect(k1.toMysAddress()).toEqual(pk1.toMysAddress());
		expect(k1.toMysAddress()).toEqual(
			'0xafedf3bc60bd296aa6830d7c48ca44e0f7a32478ae4bd7b9a6ac1dc81ff7b29b',
		);

		expect(k2.toMysAddress()).toEqual(pk2.toMysAddress());
		expect(k2.toMysAddress()).toEqual(
			'0x7e4f9a35bf3b5383802d990956d6f3c93e6184ebbbcf0820c124ab3a59ef77ac',
		);

		expect(k3.toMysAddress()).toEqual(pk3.toMysAddress());
