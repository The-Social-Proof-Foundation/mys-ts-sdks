...
const TEST_CASES = [
	[
		...
		'mysprivkey1qrwsjvr6gwaxmsvxk4cfun99ra8uwxg3c9pl0nhle7xxpe4s80y05ctazer',
		'0xa2d14fad60c56049ecf75246a481934691214ce413e6a8ae2fe6834c173a6133',
	],
	[
		'require decline left thought grid priority false tiny gasp angle royal system attack beef setup reward aunt skill wasp tray vital bounce inflict level',
		'mysprivkey1qzdvpa77ct272ultqcy20dkw78dysnfyg90fhcxkdm60el0qht9mvzlsh4j',
		'0x1ada6e6f3f3e4055096f606c746690f1108fcc2ca479055cc434a3e1d3f758aa',
	],
	[
		'organ crash swim stick traffic remember army arctic mesh slice swear summer police vast chaos cradle squirrel hood useless evidence pet hub soap lake',
		'mysprivkey1qqqscjyyr64jea849dfv9cukurqj2swx0m3rr4hr7sw955jy07tzgcde5ut',
...
describe('ed25519-keypair', () => {
	...
	it('create keypair from secret key and mnemonics matches keytool', () => {
		for (const t of TEST_CASES) {
			...
			// Decode Mys private key from Bech32 string
	...
	it('incorrect coin type node for ed25519 derivation path', async () => {
		const keypair = Ed25519Keypair.deriveKeypair(TEST_CASES[0][0], `m/44'/6976'/0'/0'/0'`);
	...
	it('incorrect purpose node for ed25519 derivation path', () => {
		expect(() => {
			Ed25519Keypair.deriveKeypair(TEST_CASES[0][0], `m/54'/6976'/0'/0'/0'`);
		}).toThrow('Invalid derivation path');
	});
