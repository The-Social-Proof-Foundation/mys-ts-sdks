...
export const DEFAULT_ED25519_DERIVATION_PATH = "m/44'/6976'/0'/0'/0'";
...
export class Ed25519Keypair extends Keypair {
	 ...
	 *
	 * If path is none, it will default to m/44'/6976'/0'/0'/0', otherwise the path must
	 * be compliant to SLIP-0010 in form m/44'/6976'/{account_index}'/{change_index}'/{address_index}'.
	 */
