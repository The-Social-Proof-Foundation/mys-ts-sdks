...
import type { NamedPackagesPluginCache } from '@socialproof/mys/src/transactions';
import { isValidNamedPackage } from '@socialproof/mys/utils';
...
const MAINNET_API_URL = 'https://mainnet.mvr.mysocial.network';
const TESTNET_API_URL = 'https://testnet.mvr.mysocial.network';
